...
test("get the ship coordinates and details", () => {
  ...
  expect(gameboard.dataShips([12, "b"], "top-to-down", 2, 2)).toEqual(
    otherShip
  );
...
test("functioning of recordedAttack", () => {
  ...
  let arrayAllAttack = new Set(["9,b", "5,d", "3,f", "2,b", "2,c"]);
  let arrayMissed = new Set(["9,b", "5,d"]);
  ...
  expect(gameboard.getSnapshot()).toEqual(
    "Ships that have been sunk: 1 - Ships afloat: 1"
  );
});
...
test("functioning of playRound", () => {
  ...
  let humanShipOne = playerReal["gameboard"].dataShips(
    [2, "b"],
    "left-to-right",
    2,
    1
  ...
  let humanShipTwo = playerReal["gameboard"].dataShips(
    [3, "f"],
    "top-to-down",
    4,
    2
  ...
  let computerShipOne = playerComputer["gameboard"].dataShips(
    [5, "b"],
    "left-to-right",
    2,
    1
  ...
  let computerShipTwo = playerComputer["gameboard"].dataShips(
    [9, "f"],
    "top-to-down",
    2,
    2
